...
You know already that you can display your model architecture by simply pronting your model in console, but sometimes it's convenient to display it as a graph.
