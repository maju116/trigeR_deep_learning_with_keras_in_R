...
# Add LSTM layer with 100 units, recurrent dropout with 0.5 rate and don't forget to return sequences to LSTM on top
# Add LSTM layer with 70 units, recurrent dropout with 0.5 rate
